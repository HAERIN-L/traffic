...
dataset_path = ["/Users/haerin/Documents/2023_캡스톤/Ransomatrix-main (2)/dataset/IoT_Botnet_Dataset_50.csv"]
...
for i, metric in enumerate(data[0].keys()):
    ...
    for j in range(len(models)):
        activation_data = [data[j][metric][k] for k in range(len(activation_functions))]  # Get the data for the specific model
